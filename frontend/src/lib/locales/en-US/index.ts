export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Open ArchiBook LLM API server could not be reached",
    ...
    docLink: "Open ArchiBook LLM Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Open ArchiBook LLM to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Open ArchiBook LLM is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Open ArchiBook LLM",
    missingRequiredModels: "Missing required models: {models}. Open ArchiBook LLM may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Open ArchiBook LLM.",
